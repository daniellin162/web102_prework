...
const totalContributions = GAMES_JSON.reduce((acc, curr) => { return acc + curr.backers }, 0);
...
const totalRaised = GAMES_JSON.reduce((acc, curr) => {
...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} ${unfundedGamesCount > 1 ? 'games remain' : 'game remains'} unfunded. We need your help to fund these amazing games`
